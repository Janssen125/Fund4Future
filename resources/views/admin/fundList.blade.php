...
@section('content')
<section class="ticketing-section d-flex justify-content-center align-items-center" style="background-color: #00A9A5">
    <div class="ticketing-container w-100 bg-light ">
            ...
            <table class="table w-75 table-bordered ">
                <thead>
                    <tr>
                        ...
                        <th scope="col" style="background-color: #00A9A5; color: white;">Owner ID</th>
                        <th scope="col" style="background-color: #00A9A5; color: white;">Funding Name</th>
                        <th scope="col" style="background-color: #00A9A5; color: white;">Total Fund</th>
        ...
        <div class="pagination d-flex justify-content-center mt-5 py-4">
