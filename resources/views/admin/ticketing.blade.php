                                ...
                                <td>
                                    <div class="icon-container d-flex justify-content-around align-items-center">
                                        ...
                                        @else
                                            ...
                                            <div class="modal fade" id="handleModal-{{ $fund->id }}" tabindex="-1"
                                                aria-labelledby="handleModalLabel-{{ $fund->id }}" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title"
                                                                id="handleModalLabel-{{ $fund->id }}">Confirm Handle
                                                            </h5>
